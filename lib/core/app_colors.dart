...
class AppColors {
  ...
  static final Color chartPrimary = darkYellow;

  //Yellows
  static final Color lightYellow = Color(0xFFfff9ec);
  static final Color yellow = Color(0xFFf4d58d);
  static final Color darkYellow = Color(0xFFffba08);
  ...
  static final Color levelButtonMedio = lightYellow;
  ...
  static final Color levelButtonBorderMedio = yellow;
  ...
  static final Color levelButtonTextMedio = darkYellow;
